export function Lp2GuaranteeSection() {
  return (
    <section className="guarantee-sec">
      <div className="container">
        <div className="guarantee-bg" style={{backgroundImage: 'url(/assets/images/banner4.html)'}}>
          <div className="row justify-content-center">
            <div className="col-md-8">
              <div className="mn-hd text-center">
                <div className="money-back-image"> <img src="/assets/images/money-back.webp" alt="" /> </div>
            ...
            <div className="col-md-12">
              <div className="btns_group text-center"> <a href="#" className="getstarted popbtn pkg-Pop" rel="be83ab3ecd0db773eb2dc1b0a17836a1">I am Ready, Let's Get Started <i className="fal fa-arrow-circle-right" /></a> </div>
            </div>
          </div>
        </div>
      </div>

export function Lp2CustomWebPkgSection() {
  return (
    <section className="br-sol custom-web-pkg">
      <div className="container">
        <div className="row align-items-center padX12">
          ...
          <div className="col-lg-6">
            <img src="/assets/images/ecom-stats.png" alt="" />
          </div>
        </div>
      </div>
    </section>

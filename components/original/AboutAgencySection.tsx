      ...
      <div className="container">
        <div className="row justify-content-between align-items-center">
          <div className="col-md-6">
            <figure>
              <img src="/assets/images/expand.png" className="img-fluid" alt="" />
            </figure>
          </div>
          <div className="col-md-6">
            <div className="abtContnt">
              {/*<img src="/assets/images/mix/4.png" class="shopImg img-fluid" alt="">*/}
              <h4 className="secHead">Leading <span>E-Commerce Shopify
              ...
              <p className="para">We’re an award-winning agency that
                ...
                by Trust Pilot. <br />
                We initiated with the mission of providing the
                best e-commerce services for our clients.
                Shopify
                ...
                sell
                their products and services online. We are a
                team of e-commerce experts with a quality-first
                attitude and years of experience, ensuring your
                online store works at it's best.</p>
            </div>
          </div>
        </div>
      </div>

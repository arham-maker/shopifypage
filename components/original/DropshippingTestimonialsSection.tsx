        ...
        <div className="row">
          <div className="col-md-12">
            <div className="common-heading">
              ...
              <p>Read the positive reviews and testimonials we’ve
                received from our happy clients. </p>
            </div>
          </div>
        </div>
        <div className="row">
          <div className="col-md-3">
            <div className="testi-box">
              ...
              <p> They are the best; the team at Shopify Page explained every step and helped
                ...
                pleasure to work with a team this much skilled
                and committed to the goals of our services. 5
                stars.
              </p>
          ...
          <div className="col-md-3">
            <div className="testi-box">
              ...
              <p>I love that they are willing to change whatever
                ...
                satisfaction are outstanding. They guided us
                through product selection and order automation
                with clear communication. My experience has been
                a 10/10. Will always work with them!
              </p>
              <div className="star-img">
                <i className="fas fa-star" />
                <i className="fas fa-star" />
          ...
          <div className="col-md-3">
            <div className="testi-box">
              ...
              <p>Shopify Page is fantastic! The team was
                ...
                suppliers, all while keeping us informed. Their
                expert support made our business run smoother
                than ever. We will continue to use them!!
              </p>
              <div className="star-img">
                <i className="fas fa-star" />
                <i className="fas fa-star" />
          ...
          <div className="col-md-3">
            <div className="testi-box">
              ...
              <p>Our sales have gone up by over 16X thanks to
                their dropshipping service! The team was
                attentive and worked closely with us to
                fine-tune product selection and streamline order
                processing. The support team was professional,
                responded quickly, and followed up with me. I
          ...
          <div className="col-md-3">
            <div className="testi-box">
              ...
              <p>The staff of Shopify Page was very
                ...
                my questions. Thank you so much for going above
                and beyond to ensure everything is perfect. I
          ...
          <div className="col-md-3">
            <div className="testi-box">
              ...
              <p>I just had to thank the awesome team at Shopify Page. I was struggling with integrating
                ...
                than an hour! My experience has been
          ...
          <div className="col-md-3">
            <div className="testi-box">
              ...
              <p>My inventory used to be a mess, but they
                streamlined everything and set up seamless order
                processing. Now, my customers receive their
                products promptly, and I can focus on growing my
                business with peace of mind. I highly recommend
                them to anyone seeking expert dropshipping
                services in the USA. 10/10 experience!
              </p>
              <div className="star-img">
                <i className="fas fa-star" />
                <i className="fas fa-star" />

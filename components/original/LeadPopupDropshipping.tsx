export function LeadPopupDropshipping() {
  return (
    <div className="popup-main2">
      <div className="closePop1">
        <i className="fas fa-times" />
      </div>
      <div className="container">
        <div className="pop-inner1">
          <h4>Build a Successful Dropshipping Store</h4>
          {/* <h3>$299</h3> */}
          <p>We are specialists in implementing powerful, robust and
            or migration to Shopify from legacy platforms.
          </p>
